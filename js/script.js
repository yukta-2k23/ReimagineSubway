...
//MEET THE GRILLS
let nextDom = document.getElementById('meetnext');
let prevDom = document.getElementById('meetprev');

let carouselDom = document.querySelector('.meetcarousel');
let SliderDom = carouselDom.querySelector('.meetcarousel .list');
let thumbnailBorderDom = document.querySelector('.meetcarousel .thumbnail');
let thumbnailItemsDom = thumbnailBorderDom.querySelectorAll('.item');
let timeDom = document.querySelector('.meetcarousel .time');
...
function showSlider(type){
    let  SliderItemsDom = SliderDom.querySelectorAll('.meetcarousel .list .item');
    let thumbnailItemsDom = document.querySelectorAll('.meetcarousel .thumbnail .item');
